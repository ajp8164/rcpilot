...
const LegalView = () => {
  ...
  return (
    <View style={s.container}>
      <TabController items={[{ label: 'Service Agreement' }, { label: 'Privacy Policy' }]}>
        ...
        <TabController.TabPage index={0}>
          <BottomSheetScrollView style={s.tabContentContainer} showsVerticalScrollIndicator={false}>
            <Text style={s.title}>{`${appConfig.businessNameShort} \nService Agreement`}</Text>
