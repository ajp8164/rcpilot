...
import helicopter from './img/modelIcons/helicopter.svg';
import multicopter from './img/modelIcons/multicopter.svg';
import robot from './img/modelIcons/robot.svg';
import sailplane from './img/modelIcons/sailplane.svg';
