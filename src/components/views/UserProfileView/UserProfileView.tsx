...
const UserProfileView = React.forwardRef<UserProfileView, UserProfileViewProps>((props, ref) => {
  const { userProfile: userProfileProp, onEditorStateChange, style = 'screen' } = props;
  ...
  return (
    <>
      <AvoidSoftInputView style={style === 'screen' ? theme.styles.view : theme.styles.viewAlt}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.container}>
          {isMyUserProfile.current ? renderEditableUserProfileHeader() : renderUserProfileHeader()}
